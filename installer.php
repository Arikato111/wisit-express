...
$json =  file_get_contents("https://api.github.com/repos/Arikato111/wisit-express/git/trees/master?recursive=1");
$jo = json_decode($json);

$tree = $jo->tree;
foreach ($tree as $value) {
    if ($value->mode == "100644") {
        $file = file_get_contents('https://github.com/Arikato111/wisit-express/blob/master/' . $value->path);
